...
public class HealthCare extends Product implements Comparable<HealthCare>{

    public HealthCare(String name, float dosage, double price) {
    ...
    public HealthCare(int id, String name, float dosage, double price, int stock) {super(id, name, dosage, price, stock);}
    ...
    @Override
    public int compareTo(HealthCare o) {
